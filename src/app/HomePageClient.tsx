...
const T = {
  en: {
    ...
    hero: {
      ...
      sublinePrimary: 'The only AI content tool built for Arabic and French from day one — not bolted on.',
      sublineSecondary: 'It writes, you approve, it posts — automatically.',
    ...
    features: {
      ...
      autoPost: {
        ...
        desc: 'ContentAI generates your content AND auto-posts it to Twitter/X. For LinkedIn, Instagram & Facebook, it prepares the post so you can copy and publish in one click — full automation for those is rolling out soon.',
        badge: 'PRO',
      },
      arabicFirst: {
        icon: '🌍',
        title: 'Built Arabic-first, not Arabic-added',
        desc: 'Most AI tools treat Arabic and French as translation jobs. ContentAI generates them natively — correct RTL layout, real cultural tone, no translation artifacts.',
        badge: 'NATIVE',
      },
      items: [
    ...
    howItWorks: {
      ...
      steps: [
        ...
        },
        {
          ...
          step: 'Step 3',
          title: 'Posted',
          desc: 'Twitter/X posts automatically at the scheduled time — nothing to do after you approve. For LinkedIn, Instagram & Facebook, ContentAI prepares the copy and gives you a one-click link to paste and publish in seconds.',
        },
      ],
      tagline: 'Most tools stop at writing. ContentAI auto-posts to Twitter/X — and makes every other platform one-click easy.',
    },
    pricing: {
      ...
      taglineAgency: "Run your clients' content like an in-house team — without doing the work yourself.",
      features: {
        ...
        pro:    [
          ...
          'Auto-posts to Twitter/X. One-click copy for LinkedIn, Instagram & Facebook.',
          'Zero steps for Twitter/X. Paste-ready copy for LinkedIn, Instagram & Facebook.',
          'Brand voice profiles so it sounds like you',
        ],
        agency: [
          'VIP — 500 gen/month',
          'Everything in Pro',
          '🏢 Separate workspace per client — brand voice, socials, and content fully isolated',
          '✅ Clients approve their own posts — sent to their inbox, no ContentAI login needed',
          'Priority support',
          'White-label ready',
        ],
      },
    ...
    faq: {
      ...
      items: [
        ...
        { q: 'What social platforms does auto-posting support?', a: 'Twitter/X posts automatically once you approve. For LinkedIn, Instagram, and Facebook, ContentAI prepares the post and gives you a one-click copy so you can paste and publish in seconds — full automation for these is rolling out soon.' },
  ...
  fr: {
    ...
    hero: {
      ...
      sublinePrimary: "Le seul outil IA conçu nativement pour l'arabe et le français — pas ajouté après coup.",
      sublineSecondary: 'Il rédige, vous approuvez, il publie — automatiquement.',
    ...
    features: {
      ...
      autoPost: {
        ...
        desc: "ContentAI génère votre contenu ET l'auto-publie sur Twitter/X. Pour LinkedIn, Instagram et Facebook, il prépare le post pour que vous puissiez copier et publier en un clic — automatisation complète pour ces plateformes bientôt disponible.",
        badge: 'PRO',
      },
      arabicFirst: {
        icon: '🌍',
        title: "Conçu pour l'arabe d'abord, pas ajouté après coup",
        desc: "La plupart des outils IA traitent l'arabe et le français comme des traductions. ContentAI les génère nativement — mise en page RTL correcte, ton culturel authentique, sans artefacts de traduction.",
        badge: 'NATIF',
      },
      items: [
    ...
    howItWorks: {
      ...
      steps: [
        ...
        },
        {
          ...
          step: 'Étape 3',
          title: 'Publié',
          desc: "Twitter/X publie automatiquement à l'heure prévue — rien à faire après votre approbation. Pour LinkedIn, Instagram et Facebook, ContentAI prépare le texte et vous donne un lien en un clic pour coller et publier en quelques secondes.",
        },
      ],
      tagline: "La plupart des outils s'arrêtent à l'écriture. ContentAI auto-publie sur Twitter/X — et rend les autres plateformes accessibles en un clic.",
    },
    pricing: {
      ...
      taglineAgency: 'Gérez le contenu de vos clients comme une équipe interne — sans faire le travail vous-même.',
      features: {
        ...
        pro:    [
          ...
          'Publie sur Twitter/X. Copie en un clic pour LinkedIn, Instagram et Facebook.',
          'Zéro étapes pour Twitter/X. Copie prête pour LinkedIn, Instagram et Facebook.',
          'Profils de ton de marque pour garder votre style',
        ],
        agency: [
          'VIP — 500 gen/mois',
          'Tout le Pro inclus',
          '🏢 Espace séparé par client — voix de marque, réseaux et contenu entièrement isolés',
          '✅ Les clients approuvent leurs publications — envoyées dans leur boîte mail, sans compte ContentAI',
          'Support prioritaire',
    ...
    faq: {
      ...
      items: [
        ...
        { q: 'Quelles plateformes sociales sont prises en charge ?', a: "Twitter/X publie automatiquement après votre approbation. Pour LinkedIn, Instagram et Facebook, ContentAI prépare le post et vous donne une copie en un clic pour coller et publier en quelques secondes — automatisation complète en cours de déploiement." },
  ...
  ar: {
    ...
    hero: {
      ...
      sublinePrimary: 'أداة الذكاء الاصطناعي الوحيدة المصممة أصلاً للعربية والفرنسية — وليست إضافة لاحقة.',
      sublineSecondary: 'يكتب، أنت توافق، وينشر — تلقائياً.',
    ...
    features: {
      ...
      autoPost: {
        ...
        desc: 'ContentAI يولّد محتواك وينشره تلقائياً على Twitter/X. بالنسبة لـ LinkedIn وInstagram وFacebook، يجهّز المنشور لك لتنسخه وتنشره بنقرة واحدة — الأتمتة الكاملة لهذه المنصات قريباً.',
        badge: 'PRO',
      },
      arabicFirst: {
        icon: '🌍',
        title: 'مصمم للعربية أولاً، لا كإضافة لاحقة',
        desc: 'تعامل معظم أدوات الذكاء الاصطناعي مع العربية والفرنسية كمهام ترجمة. ContentAI يولّدها بشكل أصيل — تخطيط RTL صحيح، نبرة ثقافية حقيقية، بدون آثار ترجمة.',
        badge: 'أصيل',
      },
      items: [
    ...
    howItWorks: {
      ...
      steps: [
        ...
        },
        {
          ...
          step: 'الخطوة 3',
          title: 'نُشر',
          desc: 'Twitter/X ينشر تلقائياً في الوقت المحدد — لا شيء تفعله بعد الموافقة. بالنسبة لـ LinkedIn وInstagram وFacebook، يجهّز ContentAI النص ويمنحك رابطاً بنقرة واحدة للنسخ واللصق في ثوانٍ.',
        },
      ],
      tagline: 'معظم الأدوات تتوقف عند الكتابة. ContentAI ينشر تلقائياً على Twitter/X — ويجعل باقي المنصات بنقرة واحدة.',
    },
    pricing: {
      ...
      taglineAgency: 'أدِر محتوى عملائك كفريق داخلي — دون أن تقوم بالعمل بنفسك.',
      features: {
        ...
        pro:    [
          ...
          'ينشر تلقائياً على Twitter/X. نسخ بنقرة لـ LinkedIn وInstagram وFacebook.',
          'صفر خطوات لـ Twitter/X. نسخ جاهز لـ LinkedIn وInstagram وFacebook.',
          'ملفات صوت العلامة لتبقى بأسلوبك',
        ],
        agency: [
          'VIP — 500 توليد/شهر',
          'كل مزايا Pro',
          '🏢 مساحة عمل منفصلة لكل عميل — صوت العلامة والشبكات والمحتوى معزول تماماً',
          '✅ العملاء يوافقون على منشوراتهم مباشرة من بريدهم — دون حاجة لحساب ContentAI',
          'دعم ذو أولوية',
    ...
    faq: {
      ...
      items: [
        ...
        { q: 'ما منصات التواصل الاجتماعي المدعومة للنشر التلقائي؟', a: 'ينشر Twitter/X تلقائياً بعد موافقتك. بالنسبة لـ LinkedIn وInstagram وفيسبوك، يجهّز ContentAI المنشور ويمنحك نسخة بنقرة واحدة لللصق والنشر في ثوانٍ — الأتمتة الكاملة قادمة قريباً.' },
  ...
  es: {
    ...
    hero: {
      ...
      sublinePrimary: 'La única herramienta de IA creada de forma nativa para árabe y francés — no añadida después.',
      sublineSecondary: 'Escribe, tú apruebas, publica — automáticamente.',
    ...
    features: {
      ...
      autoPost: {
        ...
        desc: 'ContentAI genera tu contenido Y lo publica automáticamente en Twitter/X. Para LinkedIn, Instagram y Facebook, prepara el post para que lo copies y publiques en un clic — automatización completa para esas plataformas próximamente.',
        badge: 'PRO',
      },
      arabicFirst: {
        icon: '🌍',
        title: 'Creado primero para árabe, no añadido después',
        desc: 'La mayoría de las herramientas de IA tratan el árabe y el francés como trabajos de traducción. ContentAI los genera de forma nativa — diseño RTL correcto, tono cultural real, sin artefactos de traducción.',
        badge: 'NATIVO',
      },
      items: [
    ...
    howItWorks: {
      ...
      steps: [
        ...
        },
        {
          ...
          step: 'Paso 3',
          title: 'Publicado',
          desc: 'Twitter/X publica automáticamente a la hora programada — nada que hacer tras tu aprobación. Para LinkedIn, Instagram y Facebook, ContentAI prepara el texto y te da un enlace en un clic para copiar y pegar en segundos.',
        },
      ],
      tagline: 'La mayoría de las herramientas se detienen en escribir. ContentAI publica en Twitter/X automáticamente — y hace las demás plataformas accesibles en un clic.',
    },
    pricing: {
      ...
      taglineAgency: 'Gestiona el contenido de tus clientes como un equipo interno — sin hacer el trabajo tú mismo.',
      features: {
        ...
        pro:    [
          ...
          'Publica en Twitter/X automáticamente. Copia en un clic para LinkedIn, Instagram y Facebook.',
          'Cero pasos para Twitter/X. Texto listo para copiar en LinkedIn, Instagram y Facebook.',
          'Perfiles de voz de marca para sonar siempre igual',
        ],
        agency: [
          'VIP — 500 gen/mes',
          'Todo lo de Pro',
          '🏢 Espacio separado por cliente — voz de marca, redes y contenido totalmente aislados',
          '✅ Los clientes aprueban sus publicaciones desde su email — sin cuenta en ContentAI',
          'Soporte prioritario',
    ...
    faq: {
      ...
      items: [
        ...
        { q: '¿Qué plataformas sociales admite la publicación automática?', a: 'Twitter/X publica automáticamente tras tu aprobación. Para LinkedIn, Instagram y Facebook, ContentAI prepara el post y te da una copia en un clic para pegar y publicar en segundos — automatización completa próximamente.' },
  ...
  zh: {
    ...
    hero: {
      ...
      sublinePrimary: '唯一从一开始就为阿拉伯语和法语原生构建的AI内容工具——而非事后添加。',
      sublineSecondary: '它写作，您批准，它发布——全自动完成。',
    ...
    features: {
      ...
      autoPost: {
        icon: '🚀',
        title: '自动写作并发布',
        desc: 'ContentAI为您生成内容并自动发布到Twitter/X。对于LinkedIn、Instagram和Facebook，它准备好内容供您一键复制发布——这些平台的完整自动化即将推出。',
        badge: 'PRO',
      },
      arabicFirst: {
        icon: '🌍',
        title: '阿拉伯语原生构建，而非事后添加',
        desc: '大多数AI工具将阿拉伯语和法语视为翻译任务。ContentAI以原生方式生成——正确的RTL布局、真实的文化语气，无翻译痕迹。',
        badge: '原生',
      },
      items: [
    ...
    howItWorks: {
      ...
      steps: [
        ...
        },
        {
          ...
          step: '第三步',
          title: '发布',
          desc: 'Twitter/X在计划时间自动发布——审批后无需任何操作。对于LinkedIn、Instagram和Facebook，ContentAI准备好文案，您点击即可复制粘贴，几秒完成发布。',
        },
      ],
      tagline: '大多数工具停在写作。ContentAI自动发布到Twitter/X——其他平台一键搞定。',
    },
    pricing: {
      title: '简单透明的定价',
      subtitle: '免费开始，按需升级。',
      ...
      taglineAgency: '像内部团队一样管理客户内容——无需亲自完成工作。',
      features: {
        ...
        pro:    [
          'ContentAI自动为您写内容',
          '邮件预览 — 一键审批',
          '自动发布到Twitter/X。LinkedIn、Instagram和Facebook一键复制。',
          'Twitter/X零手动操作。LinkedIn、Instagram和Facebook粘贴即发。',
          '品牌声音档案，始终保持您的风格',
        ],
        agency: [
          'VIP — 每月500次生成',
          '包含所有Pro功能',
          '🏢 每位客户独立工作区——品牌声音、社交账户和内容完全隔离',
          '✅ 客户直接通过邮件审批帖子——无需ContentAI账户',
          '优先支持',
          '支持白标',
        ],
      },
    ...
    faq: {
      ...
      items: [
        ...
        { q: '自动发布支持哪些社交平台？', a: 'Twitter/X在您批准后自动发布。对于LinkedIn、Instagram和Facebook，ContentAI准备好帖子并提供一键复制，让您粘贴发布只需几秒——完整自动化即将推出。' },
...
export default function LandingPage() {
  ...
  return (
    <div className={`min-h-screen bg-white ${isRTL ? 'font-arabic' : ''}`} dir={dir}>
      {/* ── Waitlist banner ─────────────────────────────── */}
      {WAITLIST_MODE && (
        <WaitlistBanner lang={lang} isRTL={isRTL} onJoin={() => openWaitlist('banner')} />
      )}
          ...
          <div className={`flex items-center gap-3 ${isRTL ? 'flex-row-reverse' : ''}`}>
            ...
            {WAITLIST_MODE ? (
              <button
                ...
                className="bg-brand-600 text-white px-4 py-2 rounded-xl text-sm font-semibold hover:bg-brand-700 transition-colors shadow-sm"
              >
                {t.nav.getStarted}
              </button>
            ) : (
      ...
      <section className="relative overflow-hidden hero-pattern">
        <div className="max-w-7xl mx-auto px-6 pt-20 pb-24 grid lg:grid-cols-2 gap-16 items-center">
          ...
          <div className={`${isRTL ? 'text-right' : 'text-left'}`}>
            ...
            <p className="text-lg font-semibold text-gray-900 mb-2 max-w-lg leading-snug">
              {t.hero.sublinePrimary}
            </p>

            <p className="text-base text-brand-700 mb-8 max-w-lg leading-relaxed">
              {t.hero.sublineSecondary}
            </p>
            ...
            <div className={`flex items-center gap-4 flex-wrap ${isRTL ? 'flex-row-reverse' : ''}`}>
              {WAITLIST_MODE ? (
                <button
                  ...
                  className="bg-brand-600 text-white px-7 py-3.5 rounded-2xl font-semibold text-base hover:bg-brand-700 transition-all shadow-lg hover:shadow-brand-200 hover:-translate-y-0.5"
                >
                  {t.hero.cta}
                </button>
              ) : (
      ...
      <section id="features" className="py-20 px-6">
        <div className="max-w-6xl mx-auto">
          ...
          {/* Featured cards — equal visual weight */}
          <div className={`mb-6 grid sm:grid-cols-2 gap-6 ${isRTL ? 'font-arabic' : ''}`}>
            {/* Auto-posting card */}
            <div className={`rounded-2xl p-7 border-2 border-brand-400 bg-gradient-to-br from-brand-50 via-white to-brand-50 shadow-lg flex flex-col sm:flex-row items-start gap-5 ${isRTL ? 'flex-row-reverse text-right' : ''}`}>
            ...
            {/* Arabic-first card */}
            <div className={`rounded-2xl p-7 border-2 border-amber-400 bg-gradient-to-br from-amber-50 via-white to-amber-50 shadow-lg flex flex-col sm:flex-row items-start gap-5 ${isRTL ? 'flex-row-reverse text-right' : ''}`}>
              <div className="text-5xl shrink-0">{t.features.arabicFirst.icon}</div>
              <div className="flex-1">
                <div className={`flex items-center gap-3 mb-2 flex-wrap ${isRTL ? 'flex-row-reverse' : ''}`}>
                  <h3 className="text-xl font-bold text-gray-900">{t.features.arabicFirst.title}</h3>
                  <span className="text-xs font-bold bg-amber-500 text-white px-2.5 py-1 rounded-full tracking-wide">
                    {t.features.arabicFirst.badge}
                  </span>
                </div>
                <p className="text-gray-600 leading-relaxed">{t.features.arabicFirst.desc}</p>
              </div>
            </div>
          </div>
            ...
            {(['free', 'basic', 'pro', 'agency'] as const).map(key => {
              ...
              return (
                ...
                >
                  ...
                  {WAITLIST_MODE ? (
                    <button
                      onClick={() => openWaitlist(`pricing-${key}`)}
          ...
          <div className="grid sm:grid-cols-2 gap-5">
            {t.alacarte.items.map(item => (
              <div key={item.addOnId} className={`bg-white rounded-2xl p-6 border border-gray-200 flex flex-col gap-3 ${isRTL ? 'text-right' : ''}`}>
                ...
                <button
                  onClick={() => WAITLIST_MODE ? openWaitlist(`addon-${item.addOnId}`) : handleAddOnCheckout(item.addOnId)}
      ...
      {WAITLIST_MODE && showWaitlist && (
        <WaitlistModal lang={lang} source={waitlistSource} onClose={() => setShowWaitlist(false)} />
      )}
    </div>
  )
}
